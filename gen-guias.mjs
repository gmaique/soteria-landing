...
.preco-nota{margin-top:14px;font-size:.9rem;color:var(--text-2);font-weight:300;border:1px solid var(--border);padding:14px 18px}
.preco-nota b{color:var(--text);font-weight:500}
.preco-nota a{color:var(--accent);text-decoration:underline}
...
<main class="wrap">
  ...
  <section>
    ...
    <p class="preco-nota"><b>Quanto custa?</b> Serviço avulso (laudo ou PGR) <b>a partir de R$ 1.500</b>, com visita técnica e ART inclusas — o valor exato depende do porte e do nº de funções. Pacote recorrente sob orçamento. <a href="../precos.html">Veja os formatos e valores de referência →</a></p>
  </section>
